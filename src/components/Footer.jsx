  ...
  return (
    <>
      <footer className={styles.Footer}>
        <div className={`${styles.floor}  ${styles.first_floor}`}>
          리액트 쇼핑몰
        </div>
        <ul className={`${styles.floor}  ${styles.second_floor}`}>
        ...
        <div className={`${styles.floor}  ${styles.third_floor}`}>
